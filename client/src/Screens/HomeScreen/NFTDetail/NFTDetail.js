                    ...
                    <div class="bg-transparent">
                        <section class="text-gray-700 w-full body-font bg-transparent">
                            <div class="container py-24 mx-auto">
                                <div class="w-[83vw] mx-auto flex flex-wrap glass p-10">
                                    <img alt="ecommerce" class="h-[27rem] w-[40%] rounded border border-gray-200" src={one} />
                                    <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                        <h2 class="text-sm title-font text-gray-300 tracking-widest">BRAND NAME</h2>
                                        ...
                                        <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
                                            <div class="flex">
                                                <span class="mr-3 text-gray-200">Color</span>
